...
class Agenda:
  ...
  def __eq__(self, x):
    if self.__id == x.__id and self.__data == x.__data and self.__confirmado == x.__confirmado and self.__idCliente == x.__idCliente and self.__idServico == x.__idServico:
      return True
    return False 
  def dicionario(self):
